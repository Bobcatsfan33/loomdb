...
Technical disagreement is welcome and expected here — this repository's whole review culture is built
on asking "what would make this claim false?" Pushing hard on an idea, a measurement, or a design is
not a conduct problem; it is the job.

Pushing on a *person* is. The line is between "this benchmark doesn't control for cache state" and
"you clearly don't understand benchmarking." Aim at the work.
...
by contacting them **privately through GitHub** — open a
[private security advisory](https://github.com/Bobcatsfan33/loomdb/security/advisories/new) or
message the repository owner directly. This mirrors the private-reporting route in
[SECURITY.md](SECURITY.md), and is used here because the project does not yet publish a dedicated
conduct mailbox.
